...
Nova.booting(function (Vue, router, store) {
    Vue.component('nova-numbers-card', __webpack_require__(2));
});
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h2", { staticClass: "text-center text-4xl text-80 font-light" }, [
          _c("strong", [
            _vm._v(_vm._s(_vm._f("numberFormat")(_vm.card.number)))
          ])
        ]),
        _vm._v(" "),
        _c("h4", { staticClass: "text-center text-80 font-light" }, [
